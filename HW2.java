...
public class HW2 {
	...
	public static void main(String[] args) {
		...
		if (args.length != HW2Constants.NUMBEROFARGUMENTS) {
			System.out.println("One command line arguments required");
			System.exit(HW2Constants.WRONGARGUMENTS);
		}
		
		try {
			System.setOut(new java.io.PrintStream(new java.io.FileOutputStream(args[0])));
